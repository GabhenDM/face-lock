...
senha = u"scp1234"
gabriel = Usuario('Gabriel', 'henriques.gabriel@outlook.com',  bcrypt.hashpw(senha.encode('utf8'), bcrypt.gensalt()), True)
test = Usuario('Teste', 'teste@test.com',  bcrypt.hashpw(senha.encode('utf8'), bcrypt.gensalt()), False)
